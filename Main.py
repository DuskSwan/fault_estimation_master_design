...
# import pack.func_lstm as MF
# import pack.func_wdcnn as CF
import pack.func_data as DF
import pack.func_test as TF
import pack.funcSuper as SF

from pack.FaultDegreeGUI import Ui_Form #导入窗口编辑器类
