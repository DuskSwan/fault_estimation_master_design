...
class Ui_FaultDiagnosis(object):
    def setupUi(self, FaultDiagnosis):
        ...
        self.DrawFameInTraining = QtWidgets.QFrame(self.TrainTab)
        self.DrawFameInTraining.setFrameShape(QtWidgets.QFrame.StyledPanel)
        self.DrawFameInTraining.setFrameShadow(QtWidgets.QFrame.Raised)
        self.DrawFameInTraining.setObjectName("DrawFameInTraining")
        self.horizontalLayout_4.addWidget(self.DrawFameInTraining)
        ...
        self.DrawFameInPrediction = QtWidgets.QFrame(self.PredictTab)
        self.DrawFameInPrediction.setFrameShape(QtWidgets.QFrame.StyledPanel)
        self.DrawFameInPrediction.setFrameShadow(QtWidgets.QFrame.Raised)
        self.DrawFameInPrediction.setObjectName("DrawFameInPrediction")
        self.horizontalLayout_5.addWidget(self.DrawFameInPrediction)
